        ...
        <div class="row justify-content-center">
          <div class="col-10">
            <div class="cta-trial text-center">
              <h3>Accedé a todo nuestro contenido exclusivo</h3>
             
              <a href="./login/login.php" target="_blank" class="btn btn-common btn-effect">Login</a>
            </div>
          </div>
        </div>
      </div>
