        ...
        <div class="row">
		  ...
		  <div class="col-md-12 col-sm-12">
              ...
              <div class="video-promo-content-light text-center">
					...
					<iframe width="560" height="315" src="https://youtu.be/JRn1b-pxX40" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
          </div>
        </div>
      </div>
