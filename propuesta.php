        ...
        <div class="container">          
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav mr-auto w-100 justify-content-end">
              ...
              <li class="nav-item">
                <a class="nav-link page-scroll" href="#pricing">Cotizaci&oacute;n</a>
              </li>
          ...
          <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
              ...
              <div class="carousel-caption text-left">
                ...
                <a href="#pricing" class="btn btn-lg btn-border wow fadeInRight" data-wow-delay="1.2s">Con&oacute;zcanos!</a>
              </div>
            </div>
    ...
    <div id="pricing" class="section pricing-section">
	  ...
	  <div class="container">
        <div class="section-header">          
          ...
          <p class="section-subtitle">Proponemos valores diferenciales para llevar adelante procesos de b&uacute;squedas y selecci&oacute;n de personal, detallamos con metodolog&iacute;a de trabajo una importante bonificaci&oacute;n que les otorgamos.</p>
        </div>
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12">
              <div class="video-promo-content text-center">
                ...
                <p class="wow zoomIn" data-wow-duration="1000ms" data-wow-delay="100ms">Son s&oacute;lo dos minutoss</p>
              </div>
          </div>
        </div>
      </div>
      ...
      <section class="footer-Content" id="contactenos">
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 col-mb-12">
              <div class="widget">
                <h3 class="block-title">Contactenos</h3>
                <ul class="contact-footer">
                  <li>
                    <strong>Direccin :</strong> <span>27 DE ABRIL 980 - C&oacute;rdoba, Argentina</span>
                  </li>
                  <li>
                    <strong>Phone :</strong> <span>+54 351 703-2303</span>
                  </li>
                  <li>
